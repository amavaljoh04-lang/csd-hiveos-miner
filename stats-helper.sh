...
if [[ $GPU_COUNT -eq 0 ]]; then
    echo '{"hs":[],"hs_units":"khs","temp":[],"fan":[],"uptime":0,"ver":"0.1.16","algo":"sha256d","ar":[0,0]}'
    exit 0
fi
...
OLDEST_PID=$(pgrep -f "csd-pool-miner-linux-nvidia" -o 2>/dev/null)
...
echo "{\"hs\":[$HS_ARRAY],\"hs_units\":\"khs\",\"temp\":[$TEMP_ARRAY],\"fan\":[$FAN_ARRAY],\"bus_numbers\":[$BUS_ARRAY],\"uptime\":$UPTIME,\"ver\":\"0.1.16\",\"algo\":\"sha256d\",\"ar\":[$ACCEPTED,$REJECTED]}"
